...
- [ZJUCourse](#zjucourse)
  ...
  - [大二上](#大二上)
    ...
    - [图像信息处理](#图像信息处理)
    - [普通物理学Ⅱ（H）](#普通物理学ⅱh)
    - [面向信息技术的沟通技巧](#面向信息技术的沟通技巧)
    - [程序设计与算法基础](#程序设计与算法基础)
    - [计算机逻辑设计基础](#计算机逻辑设计基础)
    - [课程综合实践Ⅰ（超算）](#课程综合实践ⅰ超算)
  - [大二下](#大二下)
    - [高级数据结构与算法分析](#高级数据结构与算法分析)
    - [数据库系统](#数据库系统)
    - [中国古代玉器](#中国古代玉器)
    - [计算机组成与设计](#计算机组成与设计)
    - [面向对象程序设计](#面向对象程序设计)
...
| 课程名称         | 老师名称 | 建设情况 | 参考来源 | 个人评价     |
| ---------------- | -------- | -------- | -------- | ------------ |
| 离散数学理论基础 | 郑文庭   | Notes    | -        | :star::star: |
| 普通物理学Ⅰ（H） | 潘正权   | Notes    | -        | :star::star: |
...
| 程序设计与算法基础     | 翁恺     | Notes     | -        | :star::star: |
| 计算机逻辑设计基础     | 王总辉   | Notes     | -        | :star::star: |
| 课程综合实践Ⅰ（超算）  | 陈建海   | 暂弃      | -        | -            |
